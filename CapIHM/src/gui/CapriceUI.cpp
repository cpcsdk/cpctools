...
CapriceWindow::CapriceWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxFrame( parent, id, title, pos, size, style, name )
{
	...
	this->Connect( m_menuItem26->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( CapriceWindow::insertTape ) );
	this->Connect( m_menuItem29->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( CapriceWindow::pressPlayOnTape ) );
...
CapriceWindow::~CapriceWindow()
{
	...
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( CapriceWindow::insertTape ) );
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( CapriceWindow::pressPlayOnTape ) );
...
RegistersStates::RegistersStates( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	sbSizer4 = new wxStaticBoxSizer( new wxStaticBox( crtc_tab, wxID_ANY, wxT("Internal Counters") ), wxVERTICAL );
	...
	sbSizer5 = new wxStaticBoxSizer( new wxStaticBox( crtc_tab, wxID_ANY, wxT("Horizontal Registers") ), wxVERTICAL );
	...
	sbSizer6 = new wxStaticBoxSizer( new wxStaticBox( crtc_tab, wxID_ANY, wxT("Vertical Registers") ), wxVERTICAL );
	...
	sbSizer12 = new wxStaticBoxSizer( new wxStaticBox( crtc_tab, wxID_ANY, wxT("Other Registers") ), wxVERTICAL );
	...
	bSizer43->Add( sbSizer14, 0, wxEXPAND, 5 );
	
	wxStaticBoxSizer* sbSizer16;
	sbSizer16 = new wxStaticBoxSizer( new wxStaticBox( ga_tab, wxID_ANY, wxT("Memory") ), wxVERTICAL );
	...
	gSizer4->Add( m_staticText103, 0, wxALL, 5 );
	
	m_textCtrl70 = new wxTextCtrl( ga_tab, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	gSizer4->Add( m_textCtrl70, 0, wxALL, 5 );
	
	sbSizer16->Add( gSizer4, 1, wxEXPAND, 5 );
	...
	ga_tab->Layout();
	bSizer43->Fit( ga_tab );
	m_nb_Register->AddPage( ga_tab, wxT("GateArray States"), true );
