;LATEST CHANGES 24/10/2010 16:08
;BOOSTER_MAIN.ASM
...
VERSION_DATA:	.DB "CPC BOOSTER+",$0D,$0A
		...
		.DB "VERSION 2.1 ",$0D,$0A
		.DB "October, 24, 2010 ",$0D,$0A,$0D,$0A
...
RD_1WIRE_RES:	RCALL DS_RESET
		OUT PORTC,A
		RJMP RD_END

RD_1WIRE_RX:	RCALL DS_RX
		OUT PORTC,B
		RJMP RD_END

WR_1WIRE_TX:	IN B,PINC
		RCALL DS_TX
		RJMP WR_END

WR_1WIRE_INIT:	IN A,PINC
		RJMP WR_END
