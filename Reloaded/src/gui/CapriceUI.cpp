...
Settings::Settings( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_notebook4->AddPage( m_panel_memory, wxT("Memory"), true );
	...
	m_regularKey->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( Settings::onKeyPress ), NULL, this );
...
Settings::~Settings()
{
	...
	m_regularKey->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( Settings::onKeyPress ), NULL, this );
